...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 justify-center",
  {
    variants: {
      variant: {
        default:
        ...
        multicolor:
          "border-black bg-gradient-to-r from-blue-600 from-0% via-slate-50 via-50% to-red-600 to-100%",
        // Rouge
...
// Define the union type of the variant values manually

              ...
              <div className={cn("relative w-full", controlClassName)}>
                <FormControl>
                  <Input
                    type="text"
                    className={cn(
                      "hover:ring-ring text-center font-bold hover:ring-1",
                      inputClassName
                    )}
                    {...field}
                    value={field.value}
                    placeholder={placeholder || tForms("pricePlaceholder")}

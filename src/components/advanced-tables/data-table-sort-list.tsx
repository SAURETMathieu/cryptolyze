  ...
  return (
    ...
    >
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild className="h-8 gap-1">
          <Button variant="primary" size="sm" onKeyDown={onTriggerKeyDown}>
            <ArrowDownUp className="size-4" />
            {tTable("sort")}
            {sorting.length > 0 && (
              <Badge
                variant="none"
                className="bg-primary-foreground text-primary ml-1 h-[18.24px] rounded-[3.2px] px-[5.12px] font-mono text-[10.4px] font-normal"
              >
                {sorting.length}
              </Badge>
            )}
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            >
              {sorting.length > 0
                ? tTable("modify_sorting_to_organize_your_rows")
                : tTable("add_sorting_to_organize_your_rows")}
            </p>
          </div>
          {sorting.length > 0 && (
      ...
      >
        ...
        >
          ...
          <SelectContent
            ...
            className="z-[9999] min-w-[var(--radix-select-trigger-width)] origin-[var(--radix-select-content-transform-origin)]"
          >

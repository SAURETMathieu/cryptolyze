...
import { formatSize } from "@/src/utils/string/formatSize";
 ...
 * @param {boolean} [params.onlyCopy=false] - Indicates if the column has only a copy button.
 * @param {string} [params.role] - Role for the column header.
 *
